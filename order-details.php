...
<div class="products-breadcrumb">
	...
	<h1 class="text-center" style="margin-bottom: 20px; margin-top: 10px;">Order Details</h1>
	<?php
		$query = "SELECT * FROM orders, address where  orders.`c_id` = {$_SESSION['c_id']} and orders.`a_id` = address.`a_id` ORDER BY o_id desc";
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="row">
							...
							<div class="col-md-6">{$row['o_datetime']}</div>
						</div>
						<div class="row">
DELIMETER;
			    if ($row['o_type'] === "Deliver") {
			        $orders.='<div class="col-md-6">Delivery Location</div>';
			    } elseif ($row['o_type'] === "Pickup") {
			        $orders.='<div class="col-md-6">Pickup Location</div>';
			    }
			$orders .=<<<DELIMETER
						...
						<div class="row">
							...
							<div class="col-md-6">{$row['total_amt']}</div>
						</div>
						<div class="row">
							<div class="col-md-6">Total Item</div>
							<div class="col-md-6">{$row5['total_item']}</div>
						</div>
						<div class="row">
							<div class="col-md-6">Order Status</div>
							<div class="col-md-6">{$row['o_status']}</div>
						</div>
						<div class="row">
							<div class="col-md-6"></div>
							<div class="col-md-6"><a class="btn btn-info" href="track.php?order_id={$row['o_id']}">TRACK</a></div>
						</div>
					</div>
				</div>
				<hr>
